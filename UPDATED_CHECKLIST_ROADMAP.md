...
## 🚨 **ملاحظات حیاتی**
- **پورتال عمومی نماینده باید در تمام مرورگرها (Safari، Chrome، Firefox) قابل دسترسی باشد**
- خطاهای فعلی: "صفحه در دسترس نیست"، "خطای غیر منتظره"، "نماینده یافت نشد"
- لینک مشکل‌دار گزارش شده: https://bcda95e7-7fc8-40bd-8159-363a21038ead-00-2cnouzhcnxnjr.kirk.replit.dev/portal/dream
...
### 3.3 بازنشانی (حذف داده‌های وبسایت)
**اولویت: متوسط**
- [ ] نمایش لیست دیتاهای قابل حذف
- [ ] انتخاب دسته‌های مورد نظر برای حذف
- [ ] تایید و حذف امن داده‌ها
...
**اولویت: بالا**
- [ ] لیست ردیفی فاکتورها به تفکیک تاریخ شمسی
- [ ] گزینه نمایش ریز جزئیات هر فاکتور در هر ردیف (ریز مصرف)
- [ ] میزان بدهی/بستانکاری کل و تعداد فاکتورهای معوق
- [ ] جدول پرداخت‌های انجام شده (ثبت شده توسط ادمین)
- [ ] نمایش پیام‌های ارسالی از پنل ادمین در کادر مشخص
- [ ] متون قابل ویرایش توسط بخش تنظیمات پورتال عمومی
...
## ❌ **موارد حذف شده از نقشه راه (بر اساس درخواست کاربر):**
